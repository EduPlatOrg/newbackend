    ...
    const events = await Event.aggregate([
      ...
      // Ajustar la proyección final para que el orden de los campos sea el deseado
      {
        $project: {
          ...
          startDate: 1, // Incluir el campo 'startDate'
          endDate: 1, // Incluir el campo 'endDate'
          mainImage: 1, // Incluir el campo 'mainImage'
