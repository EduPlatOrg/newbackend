...
export async function sendSupportMail(email, subject, message) {
  // TODO: actualizar correo de soporte

  // TODO: es correcto enviar copia al remitente?
  ...
  return await transporter.sendMail({
    ...
    html: createSupportMessage(email, subject, message),
  });
}

export const createSupportMessage = (email, subject, message) => {
  return `<!DOCTYPE html>
  <html lang="es">
  <style>
  html {
  ...
  .firma {
    ...
    <body>
      <h1>Nuevo mensaje de soporte recibido de: ${email}</h1>
